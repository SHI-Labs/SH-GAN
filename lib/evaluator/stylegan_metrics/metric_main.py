...
@register_metric
def fid50k_full_old(opts):
    opts.dataset_kwargs.update(max_size=None, xflip=False)
    fid = frechet_inception_distance.compute_fid_old(opts, max_real=None, num_gen=50000)
    return {'fid50k_full' : fid}
...
@register_metric
def fid10k_full_nerf_inpainting(opts):
    fid = frechet_inception_distance.compute_fid_nerf_inpainting(opts, max_real=None, num_gen=10000)
    return {'fid10k_full_inpainting' : fid()}

@register_metric
def fid10k_full_nerfmodgan(opts):
    fid = frechet_inception_distance.compute_fid_nerfmodgan(opts, max_real=None, num_gen=10000)
    return {'fid10k_full_inpainting' : fid()}

@register_metric
def fid1k_full_nerfmodgan(opts):
    fid = frechet_inception_distance.compute_fid_nerfmodgan(opts, max_real=None, num_gen=1000)
...
@register_metric
def fid10k_full_inpainting_wattn(opts):
    fid = frechet_inception_distance.compute_fid_inpainting_wattn(opts, max_real=None, num_gen=10000)
    return {'fid10k_full_inpainting' : fid()}
